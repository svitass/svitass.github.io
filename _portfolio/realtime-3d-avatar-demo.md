...
<div class="project-detail">
  ...
  <section class="project-detail__block">
    ...
    <div class="project-visual">
      ...
      <p class="project-visual__caption">系统控制界面，包含背景切换、动作状态控制和对话面板。</p>
      <img src="/images/projects/chat-architecture.png" alt="3D数字人系统架构图">
      <p class="project-visual__caption">项目链路涉及语音、对话、驱动与渲染模块协同。</p>
    </div>
  </section>
